...
pub mod cyan {
    pub const REGISTRATION_API: &str = "https://l726.cccc.gg/auth/register";
    pub const LOGIN_API: &str = "https://2gpt.cccc.gg/auth/login";
    pub const USER_PROFILE_API: &str = "https://dd52.cccc.gg/user";
}
...
pub mod panda {
    ...
    pub const SUBSCRIPTION_LINK_PREFIX: &str = "https://www.dnod.top/api/v1/client/subscribe?token=";
}
...
pub mod xfx_ssr {
    pub const REGISTRATION_API: &str = "https://www.xfxssr.com/api/v1/passport/auth/register";
